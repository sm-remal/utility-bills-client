  ...
  return (
    <section className="relative h-[380px] md:h-[500px] w-full overflow-hidden bg-gray-100">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-20 px-6 md:px-12">
        ...
        <button className="px-8 py-3 rounded-lg font-semibold shadow-lg mt-6 text-white bg-gradient-to-r from-pink-500 to-red-500 hover:opacity-90 transition-all duration-300">
          Explore Bills
        </button>
      </div>
