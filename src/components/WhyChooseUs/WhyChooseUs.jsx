...
//                     className={`bg-blue-200 p-8 rounded-3xl shadow-2xl transition-shadow duration-300 ${
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 300, damping: 20 }}
                    className={`bg-blue-200 p-6 rounded-2xl shadow-xl transition-shadow duration-300 ${
                      isLeft ? "md:ml-auto" : "md:mr-auto"
                    }`}
                  >
