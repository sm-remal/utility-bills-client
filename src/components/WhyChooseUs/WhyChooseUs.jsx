    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-extrabold text-center text-pink-600 mb-20"
        >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-pink-600 mb-3">{f.title}</h3>
                    <p className="text-gray-800 text-lg md:text-xl">{f.desc}</p>
                  </motion.div>
                </motion.div>
              );
            })}
